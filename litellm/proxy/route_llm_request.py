...
ROUTE_ENDPOINT_MAPPING = {
    ...
    "alist_voices": "/voices",
    "alist_voice_profiles": "/voices/profiles",
    "acreate_voice_profile": "/voices/profiles",
    "aupdate_voice_profile": "/voices/profiles/{profile_id}",
    "aget_voice_profile": "/voices/profiles/{profile_id}",
    "adelete_voice_profile": "/voices/profiles/{profile_id}",
    "ascript": "/audio/script",
...
async def route_request(
    ...
    route_type: Literal[
        ...
        "acreate_voice",
        "alist_voices",
        "alist_voice_profiles",
        "acreate_voice_profile",
        "aupdate_voice_profile",
        "aget_voice_profile",
        "adelete_voice_profile",
        "ascript",
        "atranscription",
        "amoderation",
        "arerank",
