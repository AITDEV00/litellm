...
class JWTHandler:
    ...
    async def _resolve_jwks_url(self, url: str) -> str:
        ...
        cached_jwks_uri: Final = await self.user_api_key_cache.async_get_cache(cache_key, skip_in_memory=False)
    ...
    async def _get_public_key_from_jwks_url(self, jwks_url: str, kid: str | None) -> dict:
        ...
        cached_keys: Final = await self.user_api_key_cache.async_get_cache(cache_key, skip_in_memory=False)
