...
| -------------------------- | ---------------------------------------------------------------- |
| ASR (chat-style, audio-in) | `https://litellm.ecouncil.ae/v1/chat/completions` |
...
```bash
curl -sk https://litellm.ecouncil.ae/v1/chat/completions \
  -H "Authorization: Bearer <your-api-key>" \
...
MAX_TOKENS="${2:-}"
LITELLM_URL="${LITELLM_URL:-https://litellm.ecouncil.ae/v1/chat/completions}"
